...
class ProgressController extends Controller
{
    ...
    public function show($id)
    {
        try {
            ...
            return response()->json([
                'status' => 200,
                'message' => 'progress item fetched successfully',
                'data' => $data
            ], 200);
        } catch (Exception $e) {
            return response()->json([
    ...
    public function store(Request $request)
    {
        try {
            ...
            return response()->json([
                'status' => 500,
                'message' => 'Error creating progress: ' . $e->getMessage()
            ], 500);
        }
    }
    ...
    public function destroy($id)
    {
        try {
            ...
            return response()->json([
                'status' => 500,
                'message' => 'Error deleting progress: ' . $e->getMessage()
            ], 500);
        }
    }
    ...
    private function getMockItem($id)
    {
        return [
            ...
            'description' => 'Sample progress data',
