...
class RewardController extends Controller
{
    ...
    public function show($id)
    {
        try {
            ...
            return response()->json([
                'status' => 200,
                'message' => 'rewards item fetched successfully',
                'data' => $data
            ], 200);
        } catch (Exception $e) {
            return response()->json([
    ...
    public function store(Request $request)
    {
        try {
            ...
            return response()->json([
                'status' => 500,
                'message' => 'Error creating rewards: ' . $e->getMessage()
            ], 500);
        }
    }
    ...
    public function destroy($id)
    {
        try {
            ...
            return response()->json([
                'status' => 500,
                'message' => 'Error deleting rewards: ' . $e->getMessage()
            ], 500);
        }
    }
    ...
    private function getMockItem($id)
    {
        return [
            'id' => $id,
            'name' => 'rewards Item ' . $id,
            'description' => 'Sample rewards data',
