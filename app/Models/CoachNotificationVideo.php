...
class CoachNotificationVideo extends Model
{
    use HasFactory;

    protected $table = 'coach_notification_videos';
    ...
    {
        return $this->belongsTo(NotificationVideosLibrary::class, 'cloned_from_library_id');
    }
