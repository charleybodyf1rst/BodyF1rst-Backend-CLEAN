...
class CoachNutritionVideo extends Model
{
    use HasFactory;

    protected $table = 'coach_nutrition_videos';
    ...
    {
        return $this->belongsTo(NutritionVideosLibrary::class, 'cloned_from_library_id');
    }
