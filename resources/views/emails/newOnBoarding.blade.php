...
<head>
    ...
    <title>Organization Submitted File</title>
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            ...
                                            <tr>
                                                <td class="fluid-img"
                                                    ...
                                                    New Employees Added to Your Assigned Organization
                                                </td>
                                            </tr>
                                            <tr>
                                                    ...
                                                    <table width="100%" border="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td align="center" class="text-white center "
                                                                ...
                                                                <p><strong>Dear {{ $coach['name'] }},</strong></p>
                                                                <p>We hope this message finds you well.</p>
                                                                <p>New employees have been added to the organization assigned to you:
                                                                    <strong>{{ $organization['name'] }}</strong> Please take a moment to review the details and ensure any necessary steps are taken for their onboarding or training.</p>
                                                                <p>To view the updated list of employees, kindly log in to your account. If you have any questions or need assistance, feel free to reach out to us.</p>
