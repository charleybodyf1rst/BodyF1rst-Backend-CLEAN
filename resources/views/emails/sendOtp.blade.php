													...
													<table width="100%" border="0" cellspacing="0" cellpadding="0">
														<tr>
															<td align="center" class="text-white center "
																...
																<p>We have received a request to verify your account. To
																	complete the process, please use the One-Time
																	Password (OTP) below:</p>

																<p style="font-size: 30px;
																color: #fc4d1f;
																display: block;
																margin: 20px 0 !important;"><strong>{{$user['otp']}}</strong></p>

																<p>Please
																	enter it promptly to ensure the security of your
																	account. If you did not request this, please
																	disregard this
