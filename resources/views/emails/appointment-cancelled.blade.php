                                                    ...
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                        <tr>
                                                            <td align="center" class="text-white center"
                                                                ...
                                                                <div class="cancellation-box" style="background: #fff3cd; border-left: 4px solid #ffc107; padding: 20px; margin: 20px 0; text-align: left;">
                                                                    <h3 style="margin: 0 0 10px 0; color: #856404; font-size: 16px;">⚠️ Cancellation Confirmed</h3>
                                                                    <p style="color: #856404; margin: 0;">The following appointment has been cancelled and removed from the schedule.</p>
                                                                </div>

                                                                <div class="appointment-details" style="background: #f8f9fa; padding: 20px; border-left: 4px solid #6c757d; margin: 20px 0; text-align: left;">
                                                                    <h3 style="margin: 0 0 15px 0; color: #343434; font-size: 18px;">Cancelled Appointment</h3>
                                                                    ...
                                                                    <div class="detail-row" style="padding: 8px 0; margin-top: 10px; border-top: 1px solid #e0e0e0;">
                                                                        <span class="detail-label" style="font-weight: 600; color: #343434; display: block; margin-bottom: 5px;">Reason:</span>
                                                                        <span class="detail-value" style="color: #8A97AA;">{{ $data['cancellation_reason'] }}</span>
                                                                    </div>
                                                                    @endif
                                                                </div>

                                                                <p style="margin-top: 20px;">We're sorry we won't see you this time. You can book a new appointment anytime through the BodyF1RST app.</p>

                                                                <p>If you have any questions or concerns, please contact us at <a style="color: #fc4d1f;" href="mailto:support@bodyf1rst.com">support@bodyf1rst.com</a></p>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
