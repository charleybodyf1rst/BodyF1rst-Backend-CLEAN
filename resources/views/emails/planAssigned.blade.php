                                                    ...
                                                    <table width="100%" border="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td align="center" class="text-white center "
                                                                ...
                                                                <p>You have been assigned a personalised fitness plan. This plan is designed to help you achieve your fitness goals effectively and efficiently.</p>
                                                                <p><strong>Plan Details:</strong></p>
                                                                <p><strong>Plan Name: {{$plan['title']}}</strong></p>
                                                                <p><strong>Start Date : {{$plan['start_date']}}</strong></p>
                                                                <p><strong>End Date : {{$plan['end_date']}}</strong></p>
                                                                <p>To access your plan and get started:</p>
                                                                <p>Log in to your BodyF1RST account.</p>
                                                                <p>Stay consistent and trust the process—every step brings you closer to your goals</p>
