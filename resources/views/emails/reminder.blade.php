...
<head>
    ...
    <title>Gentle Reminder For Login</title>
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                ...
                                                <td style="padding: 30px 0px 10px 0px;">
                                                    <table width="100%" border="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td class="m-center"
                                                                style="font-size:0pt; line-height:0pt; text-align:center;">
                                                                <img src="{{ asset('emails/reminder.png') }}"
                                            ...
                                            <tr>
                                                <td class="fluid-img"
                                                    ...
                                                    Complete Your Registration on BodyF1RST!
                                                </td>
                                            </tr>
                                            <tr>
                                                    ...
                                                    <table width="100%" border="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td align="center" class="text-white center "
                                                                ...
                                                                <p>We noticed you haven’t completed your registration on
                                                                    Bodyfirst, and we’re excited to have you join our
                                                                    community! To get started and explore all the
                                                                    amazing features we offer, please activate your
                                                                    account by setting up your login credentials:</p>
                                                                ...
                                                                <p>If you need any assistance or have questions, our
                                                                    support team is here to help. Please don’t hesitate
                                                                    to reach out. <a style="color: #fc4d1f;"
