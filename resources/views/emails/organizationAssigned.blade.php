...
<head>
    ...
    <title>Organization Assigned</title>
                                                    ...
                                                    <table width="100%" border="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td align="center" class="text-white center "
                                                                ...
                                                                <p>Admin has assigned an organization
                                                                    "{{ $organization['name'] }}" to
                                                                    you for management within the platform. This
                                                                    assignment
                                                                    reflects our confidence in your ability to
                                                                    contribute
                                                                    effectively and manage the associated
                                                                    responsibilities.
                                                                    Please take a moment to log into your account to
                                                                    review
                                                                    the organization’s profile and familiarize yourself
                                                                    with
