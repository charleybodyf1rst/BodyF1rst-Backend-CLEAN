													...
													<table width="100%" border="0" cellspacing="0" cellpadding="0">
														<tr>
															<td class="m-center"
																...
																<img src="{{ asset('emails/logo.png') }}"
																	width="155" style="max-width:155px;" border="0"
																	alt="" />
															</td>
														</tr>
													</table>
													...
													<table width="100%" border="0" cellspacing="0" cellpadding="0">
														<tr>
															<td align="center" class="text-white center"
                                                                ...
                                                                <p>We are pleased to inform you that a new user has successfully signed up on the platform.</p>

                                                                <p><strong>User Details:</strong></p>
                                                                <p>Name: <strong>{{$user['first_name']}} {{$user['last_name']}}</strong></p>
                                                                <p>Email: <strong>{{$user['email']}}</strong></p>

                                                                <p>Please review the new user's information and ensure proper onboarding and verification if necessary.</p>

                                                                <p>If you have any questions or need further assistance, please feel free to contact our support team at <a
                                                                        style="color: #fc4d1f;" href="mailto:support@bodyf1rst.com">
