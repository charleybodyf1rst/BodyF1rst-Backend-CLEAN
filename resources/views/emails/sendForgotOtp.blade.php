                                                ...
                                                <td style="padding: 30px 0px 10px 0px;">
                                                    <table width="100%" border="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td class="m-center"
                                                                style="font-size:0pt; line-height:0pt; text-align:center;">
                                                                <img src="{{ asset('emails/otp.png') }}" width="155"
                                                                    style="max-width:155px;" border="0"
                                                                    alt="" />
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td align="center" class="text-white center "
                                                                ...
                                                                <p>We received a request to reset the password for your
                                                                    account associated with this email. Please use the
                                                                    following One-Time Password (OTP) to reset your
                                                                    password:</p>
                                                                ...
                                                                <p>If you did not request a password reset, please
                                                                    ...
                                                                    Enter the above OTP on the password reset page.
