                                                ...
                                                <td style="padding: 30px 0px 10px 0px;">
                                                    <table width="100%" border="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td class="m-center"
                                                                style="font-size:0pt; line-height:0pt; text-align:center;">
                                                                <img src="{{ asset('emails/credentials.png') }}"
                                                    ...
                                                    <table width="100%" border="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td align="center" class="text-white center "
                                                                ...
                                                                <p><strong>Dear
                                                                        {{ "{$credential['type']} {$credential['name']}" }},</strong>
                                                                </p>

                                                                @if ($credential['type'] == 'User')
                                                                @php
                                                                    $name = $credential['coach'] ?? 'BodyF1RST';
                                                                @endphp
                                                                    <p>Your account has been successfully created by the
                                                                        <strong>
                                                                            {{ "{$credential['role']} : {$name}" }}
                                                                        </strong>
                                                                        @if($credential['organization'])
                                                                            . You are a part of this organization <strong>"{{$credential['organization']}}"</strong>
                                                                        @endif
                                                                        . To get started, please use the following
                                                                        credentials to register on our mobile app:</p>
                                                                @else
                                                                @php
                                                                    $name = $credential['coach'];
                                                                @endphp
                                                                    <p>Your account has been successfully created by the
                                                                        <strong>
                                                                            {{ "{$credential['role']} : {$name}" }}
                                                                        ...
                                                                        . To get started, please use the following
                                                                        credentials to log in to the coach panel and
                                                                        manage your activities:</p>
                                                                @endif
                                                                ...
                                                                @if ($credential['type'] == 'User')
                                                                    <p>Download the app and log in to explore all the
                                                                        features and services we have to offer.</p>
                                                                        <tr>
                                                                            <td class="pb30" align="center"
                                                                                style="padding-bottom:15px;">
                                                                                <table border="0" cellspacing="0" cellpadding="0">
                                                                                    <tr>
                                                                                        <td class="img" width="160"
                                                                                            style="font-size:0pt; line-height:0pt; text-align:center; padding:0 5px;">
                                                                                            <a href="https://play.google.com/store/apps/details?id=xyz.bodyf1rst.codexia&pcampaignid=web_share"
                                                                                                target="_blank"><img
                                                                                                    src="{{ asset('emails/download-google-app.png') }}"
                                                                                                    width="150" style="max-width:150px;"
                                                                                                    border="0" alt="" /></a>
                                                                                        </td>
                                                                                        <td class="img" width="160"
                                                                                            style="font-size:0pt; line-height:0pt; text-align:center; padding:0 5px;">
                                                                                            <a href="https://apps.apple.com/pk/app/bodyf1rst1-0/id6738378732"
                                                                                                target="_blank"><img
                                                                                                    src="{{ asset('emails/download-store-app.png') }}"
                                                                                                    width="150" style="max-width:150px;"
                                                                                                    border="0" alt="" /></a>
                                                                                        </td>
                                                                                    </tr>
                                                                ...
                                                                @else
                                                                    <p>Access the coach panel to manage your activities,
                                                                        view analytics, and interact with your users
                                                                        seamlessly.</p>
                                                                    <div class="text-button white-button"
                                                                        ...
                                                                        <a href="https://bodyf1rst-5672e.web.app/login"
                                                                            target="_blank" class="link"
                                                                            style="display: inline-block; width: 200px; text-align:center;padding: 10px 15px;border-radius:30px; background:#fc4d1f; color:#ffffff; font-weight:bold;text-decoration:none;">
                                                                            <span class="link"
                                                                                style="color:#ffffff;text-decoration:none;">Go
                                                                                to Coach Panel</span>
                                                                        </a>
                                                                    </div>
                                                                @endif
                                                                <p>If you encounter any issues or have questions, please
                                                                    feel free to contact our support team. <a
                                                                        style="color: #fc4d1f;"
