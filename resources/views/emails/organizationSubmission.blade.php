...
<head>
    ...
    <title>Organization Submission Form</title>
                                                ...
                                                <td style="padding: 30px 0px 10px 0px;">
                                                    <table width="100%" border="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td class="m-center"
                                                                style="font-size:0pt; line-height:0pt; text-align:center;">
                                                                <img src="{{ asset('emails/submission-form.png') }}"
                                                    ...
                                                    <table width="100%" border="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td align="center" class="text-white center "
                                                                ...
                                                                <p><strong>Dear
                                                                        {{ $organization['poc_name'] }},</strong></p>
                                                                <p>You have been invited by the admin to complete the
                                                                    organization form. Your input is essential to ensure
                                                                    smooth collaboration and accurate record-keeping.
                                                                </p>
                                                                <p>Please click the button below to access the form and
                                                                    provide the necessary details.</p>
                                                                <div class="text-button white-button"
                                                                    ...
                                                                    <a href="{{ $organization['url'] }}{{ $organization['token'] }}"
                                                                        ...
                                                                        style="display: inline-block; width: 200px; text-align:center;padding: 10px 15px;border-radius:30px; background:#fc4d1f; color:#ffffff; font-weight:bold;text-decoration:none;"><span
                                                                            ...
                                                                            Complete the Form</span></a>
                                                                </div>

                                                                <p>If you have any questions or need assistance, feel
                                                                    free to reach out to us. <a style="color: #fc4d1f;"
