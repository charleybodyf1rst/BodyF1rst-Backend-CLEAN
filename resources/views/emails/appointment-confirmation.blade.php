                                                    ...
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                        <tr>
                                                            <td align="center" class="text-white center"
                                                                ...
                                                                <p>Your appointment with <strong>{{ $data['coach_name'] }}</strong> has been confirmed!</p>
                                                                ...
                                                                <div class="appointment-details" style="background: #f8f9fa; padding: 20px; border-left: 4px solid #fc4d1f; margin: 20px 0; text-align: left;">
                                                                    ...
                                                                    <div class="detail-row" style="padding: 8px 0; margin-top: 10px; border-top: 1px solid #e0e0e0;">
                                                                        <span class="detail-label" style="font-weight: 600; color: #343434; display: block; margin-bottom: 5px;">Notes:</span>
                                                                        <span class="detail-value" style="color: #8A97AA;">{{ $data['notes'] }}</span>
                                                                    </div>
                                                                    @endif
                                                                </div>

                                                                <p style="margin-top: 20px;">We look forward to seeing you! If you need to reschedule or cancel, please do so at least 24 hours in advance.</p>

                                                                <p>If you have any questions, contact us at <a style="color: #fc4d1f;" href="mailto:support@bodyf1rst.com">support@bodyf1rst.com</a></p>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
