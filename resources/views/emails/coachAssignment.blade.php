...
<head>
    ...
    <title>Organizations/Users Assigned</title>
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                ...
                                                <td style="padding: 30px 0px 10px 0px;">
                                                    <table width="100%" border="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td class="m-center"
                                                                style="font-size:0pt; line-height:0pt; text-align:center;">
                                                                <img src="{{ asset('emails/org-assigned.png') }}"
                                            ...
                                            <tr>
                                                <td class="fluid-img"
                                                    ...
                                                    Organizations/Users Assigned to You
                                                </td>
                                            </tr>
                                            <tr>
                                                    ...
                                                    <table width="100%" border="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td align="center" class="text-white center "
                                                                ...
                                                                <p><strong>Dear Coach {{ $coach->name }},</strong></p>
                                                                @php
                                                                    $messageBody = "";
                                                                    $organizationNames = $organizations ? $organizations->pluck('name')->toArray() : [];
                                                                    $userNames = $users ? $users->map(function ($user) {
                                                                        return $user->first_name . ' ' . $user->last_name;
                                                                    })->toArray() : [];

                                                                    if (count($organizationNames) > 3) {
                                                                        $messageBody = "assigned organizations: <strong> " . implode(', ', array_slice($organizationNames, 0, 3)) . " and " . (count($organizationNames) - 3) . " more.</strong>";
                                                                    } elseif (!empty($organizationNames)) {
                                                                        $messageBody = "assigned organizations: <strong>" . implode(', ', $organizationNames) . ".</strong>";
                                                                    }

                                                                    if (count($userNames) > 3) {
                                                                        $messageBody .= (!$organizations->isEmpty() ? " And " : " assigned ") . "users: <strong> " . implode(', ', array_slice($userNames, 0, 3)) . " and " . (count($userNames) - 3) . " more.</strong>";
                                                                    } elseif (!empty($userNames)) {
                                                                        $messageBody .= (!$organizations->isEmpty() ? " And " : " assigned ") . "users: <strong>" . implode(', ', $userNames) . ".</strong>";
                                                                    }

                                                                    if (empty($userNames) && empty($organizationNames)) {
                                                                        $messageBody = "No organizations or users assigned.";
                                                                    }
                                                                @endphp

                                                                <p>BodyF1RST has {!! $messageBody !!} to you for management within the platform. This assignment reflects our confidence in your ability to contribute effectively and manage the associated responsibilities. Please take a moment to log into your account to review the organization’s profile and familiarize yourself with the tasks and settings.</p>
                                                                <div class="text-button white-button"
                                                                    ...
                                                                    <a href="{{$coach->url}}" target="_blank" class="link"
                                                                ...
                                                                <p>If you have any questions or need assistance, feel
                                                                    free
                                                                    to reach out to our support team or the admin for
                                                                    guidance. <a style="color: #fc4d1f;"
