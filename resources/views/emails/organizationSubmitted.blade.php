                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                ...
                                                <td style="padding: 30px 0px 10px 0px;">
                                                    <table width="100%" border="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td class="m-center"
                                                                style="font-size:0pt; line-height:0pt; text-align:center;">
                                                                <img src="{{ asset('emails/sub-req.png') }}"
                                                                    width="155"
                                            ...
                                            <tr>
                                                <td class="fluid-img"
                                                    ...
                                                    Organization Details Submitted by Point of Contact
                                                </td>
                                            </tr>
                                            <tr>
                                                    ...
                                                    <table width="100%" border="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td align="center" class="text-white center "
                                                                ...
                                                                <p>Point of Contact (PoC) for
                                                                    <strong>{{ $organization['name'] }}</strong> has
                                                                    successfully submitted the
                                                                    organization's details. You can now review the
                                                                    submission in the admin panel.</p>
